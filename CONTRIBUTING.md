...
To that end, we follow the [18F Code of Conduct](https://github.com/18F/code-of-conduct/blob/master/code-of-conduct.md) and ask that all contributors do the same. Open Opps has a defined [governance model](https://github.com/18F/code-of-conduct/blob/master/GOVERNANCE.md) to assist with managing the project.
